...
- ["Why eBPF is Changing the Networking Landscape" (Thomas Graf, KubeCon talk)](https://www.youtube.com/watch?v=Qhg19gDwJAc) -- A foundational talk by the Cilium creator explaining why eBPF fundamentally changes what is possible in kernel-level networking and why iptables-based approaches hit a scalability wall.
