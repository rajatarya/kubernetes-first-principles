...
- [Brendan Burns -- "The Illustrated Children's Guide to Kubernetes" (CNCF)](https://www.youtube.com/watch?v=4ht22ReBjno) --- A surprisingly effective introduction to Kubernetes concepts through visual storytelling, by one of its co-founders.
